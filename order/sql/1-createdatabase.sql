...
create table purchase_seq (next_val bigint) engine=InnoDB;
insert into purchase_seq values ( 1 );
...
create table purchase_product_seq (next_val bigint) engine=InnoDB;
insert into purchase_product_seq values ( 1 );